...
const ModalAdd = ({ currentCompany, toggleModal, type, updateDBError }) => {
  ...
  const handleUtbildningar = e => {
    ...
    if (utbildningar.includes(e.target.name)) {
      const newArr = utbildningar.filter(utbildning => utbildning !== e.target.name)
  ...
  const handleAnteckningar = e => {
    setAnteckningar(e.target.value)
  }
  ...
  return (
    <div className="add-modal">
      <p className="close-modal-button" aria-label="Close" onClick={e => toggleModal(e)}>
        &#10006;
      </p>
      <section className="form-section">
        <label htmlFor="företagsnamn">Företagets namn:</label>
        <input type="text" name="företagsnamn" value={namn} onChange={handleName} required />
      </section>

      <section className="form-section">
        <label htmlFor="beskrivning">Beskriv företaget:</label>
        <textarea name="beskrivning" id="" cols="30" rows="5" value={beskrivning} onChange={handleBeskrivning}></textarea>
      </section>

      <section className="form-section">
        <label htmlFor="hemsida">Hemsida - måste börja med http(s):</label>
        <input type="text" name="hemsida" value={hemsida} onChange={handleHemsida} />
      </section>

      <section className="form-section">
        <label htmlFor="kontaktEpost">Kontakt Epost:</label>
        <input type="email" name="kontaktEpost" value={kontaktEpost} onChange={handleKontaktEpost} />
      </section>

      <section className="form-section">
        <label htmlFor="kontaktWebbsida">Kontakt Webbsida - måste börja med http(s):</label>
        <input type="text" name="kontaktWebbsida" value={kontaktWebbsida} onChange={handleKontaktWebbsida} />
      </section>
      ...
      <section className="form-section">
        ...
        <div>
          <input type="checkbox" id="WU" name="WU" onChange={handleUtbildningar} defaultChecked={utbildningar.includes('WU')} />
        ...
        <div>
          <input type="checkbox" id="ITP" name="ITP" onChange={handleUtbildningar} defaultChecked={utbildningar.includes('ITP')} />
        ...
        <div>
          <input type="checkbox" id=".NET" name=".NET" onChange={handleUtbildningar} defaultChecked={utbildningar.includes('.NET')} />
        ...
        <div>
          <input type="checkbox" id="JAVA" name="JAVA" onChange={handleUtbildningar} defaultChecked={utbildningar.includes('JAVA')} />
        ...
        <div>
          <input type="checkbox" id="FEU" name="FEU" onChange={handleUtbildningar} defaultChecked={utbildningar.includes('FEU')} />
        ...
        <div>
          <input type="checkbox" id="JSU" name="JSU" onChange={handleUtbildningar} defaultChecked={utbildningar.includes('JSU')} />
        ...
        <div>
          <input type="checkbox" id="APP" name="APP" onChange={handleUtbildningar} defaultChecked={utbildningar.includes('APP')} />
        ...
        <div>
          <input type="checkbox" id="TEST" name="TEST" onChange={handleUtbildningar} defaultChecked={utbildningar.includes('TEST')} />
      ...
      <section className="form-section">
        ...
        <div className="radio-btns" onChange={handleITHSMatchar}>
          <input type="radio" id="ja" name="ITHSMatchar" value="ja" defaultChecked={ITHSMatchar} />
          <label htmlFor="ja">JA</label>

          <input type="radio" id="nej" name="ITHSMatchar" value="nej" defaultChecked={!ITHSMatchar} />
      ...
      <section className="form-section">
        <label htmlFor="anteckningar">Anteckningar (osynliga för elever):</label>
        <textarea name="anteckningar" id="" cols="30" rows="5" value={anteckningar} onChange={handleAnteckningar}></textarea>
      </section>

      <section className="form-section">
        <p>Synlig för studerande:</p>
        <div className="radio-btns" onChange={handleSynlig}>
          <input type="radio" id="ja" name="synlig" value="ja" defaultChecked={synlig} />
          <label htmlFor="ja">JA</label>

          <input type="radio" id="nej" name="synlig" value="nej" defaultChecked={!synlig} />
          <label htmlFor="nej">NEJ</label>
        </div>
      </section>
      ...
      {type === 'edit' ? (
        <section className="buttons">
          <BaseButton color="danger" toggleModal={toggleModal} data={{ ...company, id: currentCompany.id }}>
            SPARA ÄNDRINGAR
          </BaseButton>
          <BaseButton color="grey" toggleModal={toggleModal}>
            AVBRYT
